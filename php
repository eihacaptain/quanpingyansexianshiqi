...
<head>
    ...
    <style>
        * {
        ...
        body {
            background-color: #000000;  /* 初始黑色，后续会随颜色改变 */
            min-height: 100vh;
            display: flex;
...
<div class="glass-panel">
    ...
    <footer>点击播放 ▶ 全屏沉浸色彩 · 单击画面或按 ESC 退出</footer>
</div>
...
<script>
    (function(){
        ...
        // 全屏展示（无文字覆盖层）
        async function enterFullscreenWithColor() {
            fullscreenOverlay.style.backgroundColor = currentColor;
        ...
        async function exitFullscreenAndClean() {
        ...
        async function onPlayClick() {
            ...
            await enterFullscreenWithColor();
        }
